    ...
    # 一回前の画面を綺麗に消す処理
        ...
        for y in range(len(self.map)):
            for x in range(len(self.map[y])):
                if self.map[y][x] == 0:
                    pygame.draw.rect(screen, (255, 255, 255), (int(siz*x), int(siz*y), int(siz), int(siz)))
                if self.map[y][x] == 1:
                    pygame.draw.rect(screen, (0, 0, 0), (int(siz*x), int(siz*y), int(siz), int(siz)))
                if self.map[y][x] == 2:
                    pygame.draw.rect(screen, (0, 255, 255), (int(siz*x), int(siz*y), int(siz), int(siz)))
                if self.map[y][x] == 3:
                    pygame.draw.rect(screen, (255, 0, 0), (int(siz*x), int(siz*y), int(siz), int(siz)))
                if self.map[y][x] == 4:
                    pygame.draw.rect(screen, (255, 100, 100), (int(siz*x), int(siz*y), int(siz), int(siz)))
